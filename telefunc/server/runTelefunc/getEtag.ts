...
async function getEtag(callContext: { _disableEtag: boolean; _httpResponseBody: string }): Promise<string | null> {
  ...
  const etag = computeEtag(callContext._httpResponseBody, createHash)
  return etag
}
