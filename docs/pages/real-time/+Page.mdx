...
For reactive streams with full operator support, see <Link href="/extensions/rxjs" text={<code>@telefunc/rxjs</code>} /> — pass `Observable` and `Subject` transparently in both directions.
