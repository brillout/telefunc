...
Thus, it's recommended against defining other kinds of logic inside them, as it conflates the purpose of `.telefunc.js` files, making your code harder to understand and maintain.
