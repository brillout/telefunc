...
export const onTodoTextUpdate = async (id: number, text: string) => await updateTask(id, { text })
// Doesn't return task.modifiedAt
export const onTodoCompleted = async (id: number) => await updateTask(id, { completed: false })
```
