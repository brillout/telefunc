...
> Not following the naming convention is perfectly fine, though we recommend having a clear reason for breaking the rule. [Feel free to reach out](https://github.com/brillout/telefunc/issues/new) if you have quesions.
