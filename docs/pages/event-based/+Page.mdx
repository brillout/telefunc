...
In the example below, we explain why it leads to better <Link href="/RPC#security">RPC security</Link> and increased <Link href="/RPC#speed">RPC speed</Link>.
...
> - Increased <Link href="/RPC#speed">RPC speed</Link>
>
