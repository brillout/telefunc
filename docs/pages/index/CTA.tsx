...
const CTAButtons = (props: HTMLAttributes<HTMLDivElement>) => {
  return (
    <div className={cmMerge('flex justify-center gap-x-5 mx-9 not-prose my-10', props.className)} {...props}>
      <Link href={`/docs/quick-start`} className="btn btn-secondary lg:btn-lg">
        Get started
      </Link>
      <Link href={`/docs/concepts`} className="btn btn-ghost border-base-content bg-transparent lg:btn-lg">
        Learn more
      </Link>
    </div>
  )
