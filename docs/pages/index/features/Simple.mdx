...
Creating new telefunctions is cheap; instead of trying to create generic telefunctions and trying to re-use them, we simply create a new telefunction for each frontend need.

In other words, instead of thinking in terms of generic enpdoints, your frontend simply direclty use any SQL/ORM query it needs to do its job.
