...
Telefunc can be used in any JavaScript environment without using a transformer but, for improved convenience, it's recommended to use a transformer plugin if possible.
