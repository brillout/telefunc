...
If we use Vite, you can transform `*.telefunc.js` files by using the Telefunc's Vite plugin:
...
If we use webpack, you can transform `*.telefunc.js` files by using the Telefunc's webpack plugin:
