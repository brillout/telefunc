...
Before we can use `getContext()`, we need to provide the `context` object to the Telefunc server middleware, see:
- <Link href="/server" />
- <Link href="/telefunc" />

// TODO/ai use react-tabs to toggle between Hono and Express.js — see https://github.com/vikejs/vike/blob/3faa3d308366e583e479385fafd42a171d81dcc8/docs/pages/migration/vike-photon/+Page.mdx#L2-L3

For example, with Hono or Express.js:
