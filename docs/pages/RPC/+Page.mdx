...
> This page explains:
> - What RPC is.
> - How RPC (e.g. Telefunc) works.
> - That RPC endpoints (e.g. telefunctions) need protection.
>
...
> While the examples here use JSX note that Telefunc works with any UI framework (React, Vue, Angular, Svelte, ...).
...
This means our frontend can directly tap into the full power of SQL/ORM engines.
It's both simpler and more powerful than REST/GraphQL.

> GraphQL/RESTful API is usually only needed if:
> - we want to give third parties generic access to our database, or
