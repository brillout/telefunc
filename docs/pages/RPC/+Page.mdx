...
shield([shield.type.string], onNewTodo)
...
shield([{ text: t.string, isCompleted: t.boolean }], onNewTodo)
...
shield([shield.type.number], onDelete)
...
shield([shield.type.number], onTodoComplete)
