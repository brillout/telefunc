...
Since telefunctions are public and can be called by anyone, we cannot assuming anything about arguments. You can use `throw Abort()` to ensure the type of telefunction arguments:
