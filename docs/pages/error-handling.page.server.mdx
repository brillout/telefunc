...
We can propagate error information to the frontend by using `throw Abort(someValue)`, see for example <Link href="/permissions#getcontext-wrapping" doNotInferSectionTitle={true} />.
