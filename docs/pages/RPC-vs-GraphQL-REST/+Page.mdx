...
But you can as well achieve a decoupled frontend-backend development with RPC by using what is called a *Telefunc Server*.
...
you can create a GraphQL API that is simpler to use.
