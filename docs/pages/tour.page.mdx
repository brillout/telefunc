...
> We still need a GraphQL/RESTful API if we want to enable third parties to access our database,
> or if we are a (very) large company with highly complex databases.
> We elaborate more at <Link href="/RPC-vs-GraphQL-REST" />.
...
If we want to pass information to the frontend,
