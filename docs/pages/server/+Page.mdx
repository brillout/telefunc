...
You can add Telefunc to any server that uses the standard `Request` object (e.g., [Hono](https://hono.dev)), or the Node.js `req` readable stream (e.g., [Express](https://expressjs.com) or [Fastify](https://fastify.dev)).
