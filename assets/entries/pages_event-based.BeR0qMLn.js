...
`,e.jsxs(n.p,{children:["As explained in ",e.jsx(s,{href:"#example",children:"the example above"}),", for a clear structure and efficient Telefunc usage, we recommend the following convention."]}),`
