import{j as e,i as a,L as t,o}from"../chunks/chunk-DpSLeoD8.js";import{L as s}from"../chunks/chunk-qlkBBYns.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DrXegnsw.js";/* empty css                      */const c=[{pageSectionId:"basic-example",pageSectionLevel:2,pageSectionTitle:"Basic example"},{pageSectionId:"orm-sql",pageSectionLevel:2,pageSectionTitle:"ORM & SQL"},{pageSectionId:"how-it-works",pageSectionLevel:2,pageSectionTitle:"How it works"},{pageSectionId:"rpc-security",pageSectionLevel:2,pageSectionTitle:"RPC security"},{pageSectionId:"throw-abort",pageSectionLevel:2,pageSectionTitle:"`throw Abort()`"},{pageSectionId:"shield",pageSectionLevel:2,pageSectionTitle:"`shield()`"},{pageSectionId:"random-telefunction-calls",pageSectionLevel:2,pageSectionTitle:"Random telefunction calls"},{pageSectionId:"rpc-speed",pageSectionLevel:2,pageSectionTitle:"RPC speed"}];function r(l){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["Telefunc's approach — seamlessly calling remote functions — is known as ",e.jsxs(n.a,{href:"https://en.wikipedia.org/wiki/Remote_procedure_call",children:["RPC (",e.jsx(n.strong,{children:"R"}),"emote ",e.jsx(n.strong,{children:"P"}),"rocedure ",e.jsx(n.strong,{children:"C"}),"all)"]}),"."]}),`
`,e.jsx(n.p,{children:"This page explains:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"What is RPC?"}),`
`,e.jsx(n.li,{children:"How does RPC work?"}),`
`,e.jsx(n.li,{children:"How to ensure RPC security?"}),`
`,e.jsx(n.li,{children:"How to maximize RPC speed?"}),`
`]}),`
...
`]}),`
`,e.jsx("h2",{id:"rpc-security",children:"RPC security"}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"  // ..."})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsx("h2",{id:"rpc-speed",children:"RPC speed"}),`
...
`,e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// TodoList.telefunc.ts"})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// Environment: server"})}),`
`,e.jsx(n.span,{"data-line":"",children:" "}),`
...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsx(n.p,{children:"Even with GraphQL, the client must specify and send the list of fields that the server needs to return. This isn't needed with RPC — that information is implicity defined by the telefunction name (i.e. the information is compressed)."}),`
`]}),`
