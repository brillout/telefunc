...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Don't use ",e.jsx(n.code,{children:"throw new Error()"})," instead of ",e.jsx(n.code,{children:"throw Abort()"}),". While ",e.jsx(n.code,{children:"throw new Error()"})," also interrupts the telefunction call, Telefunc interprets it as a bug, see ",e.jsx(s,{href:"/abort-vs-error"}),"."]}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
