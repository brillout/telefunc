import{j as e,i as t,L as a,o}from"../chunks/chunk-D2UmQORZ.js";import{L as i}from"../chunks/chunk-DN8D2-Pa.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-BBgmeRTV.js";/* empty css                      */const r=[{pageSectionId:"example",pageSectionLevel:2,pageSectionTitle:"Example"},{pageSectionId:"naming-convention",pageSectionLevel:2,pageSectionTitle:"Naming convention"},{pageSectionId:"exception-several-clients",pageSectionLevel:2,pageSectionTitle:"Exception: several clients"}];function s(l){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"With REST or GraphQL, API endpoints are:"}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Not following the naming convention is perfectly fine, though we recommend having a clear reason for breaking the rule. ",e.jsx(n.a,{href:"https://github.com/brillout/telefunc/issues/new",children:"Feel free to reach out"})," if you have quesions."]}),`
`]}),`
