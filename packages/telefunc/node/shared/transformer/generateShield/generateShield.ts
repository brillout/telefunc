...
function generateShieldCode({
  ...
  // Delete the temporary shieldGen source file to prevent it from being picked up by TypeScript during builds
  // This avoids TS6196 "declared but never used" errors for the type aliases we created
