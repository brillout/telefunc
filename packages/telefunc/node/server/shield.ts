...
function shield<
  V extends unknown[],
  ArgumentVerifyers extends [...V],
  Telefunction extends (...args: ArgumentVerifyers) => unknown,
>(telefunction: Telefunction, verifiers: ArgumentVerifyers, options?: ShieldOptions): Telefunction {
